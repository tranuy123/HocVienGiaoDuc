 ...
 */
@WebServlet("/sendmail1control")
public class sendmail1control extends HttpServlet {
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(email!=null || !email.equals("")) {
			...
			try {
				...
				message.setSubject("Học viện giáo dục TP.HCM xin chào");
				message.setText("Mã đăng ký khóa học của bạn là : " + s+"\n");
				// send message
