            ...
            <div class="card">
              ...
              >
                <img
                  ...
                  src="images/${o.images }"
                />
                <h5 style="margin-top: 10px">${o.tieude }</h5>
                <h6>${o.tacgia }</h6>
                <div
                  class="social-links"
                ...
                >
                  <div>
                    ...
                    ></a>
                    <a href="deletenewscontrol?matt=${o.matt }" class="Xoa"><i class="bi bi-trash"></i></a>
                  </div>
                  <a href="CTLoa.html" class="chitiet"><i class="=">Chi tiết</i></a>
                </div>
              </div>
            </div>
          </ul>
        ...
        <div id="addModal" class="modal">
          ...
          <div class="modal-dialog">
              ...
              <div class="modal-content">
                  ...
                  <form action="insertnewscontrol" method="get">
                      ...
                      <div class="modal-body">	
                        <div class="form-group">
                          ...
                          <div class="form-group">
                              <label>footer</label>
                              <input name="footer" class="form-control" required></input>
                          </div>
                          <div class="form-group">
                              <label>Tác giả</label>
                              <input name="tacgia" class="form-control" required></input>
                          </div>  
                          <div class="form-group">
                            <label>Ngày đăng</label>
                            <input name="ngaydang" type="date"class="form-control" required></input>
                          </div> 
