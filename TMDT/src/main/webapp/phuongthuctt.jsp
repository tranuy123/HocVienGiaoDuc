...
<div style="display: flex;justify-content: center;background-color: #badbdc; height: 100%;">
    ...
    <div class="MuiBox-root jss2472 jss2455">
        <div class="MuiBox-root jss2473">
            ...
            <input value="${sessionScope.acc.email}" name="email" type="text" style="width: 150px; height:25px; font-size: 16px;">
        </div>
        <div class="MuiBox-root jss2474">
            <span class="MuiTypography-root MuiTypography-caption">Sau khi hoàn tất thanh toán, Mã đăng ký khóa học sẽ được gửi ngay qua SMS và Email của bạn.</span>
        </div>
